# ===================================================================
# HELLION POWER TOOL - MODULAR VERSION v8.0.0.0 "Jörmungandr"
...
if (-not ([Security.Principal.WindowsPrincipal] [Security.Principal.WindowsIdentity]::GetCurrent()).IsInRole([Security.Principal.WindowsBuiltInRole]::Administrator)) {
    ...
    Write-Information "`nDieses Tool benötigt Administrator-Rechte für System-Änderungen." -InformationAction Continue
    Write-Information "Es wird nun ein Neustart mit erhöhten Rechten angefordert." -InformationAction Continue
    ...
    try {
        ...
        Write-Host "================================================================" -ForegroundColor Red
        Write-Host ""
        Write-Host "Das Tool kann ohne Administrator-Rechte nicht ausgeführt werden." -ForegroundColor White
        Write-Host ""
...
# Get script root directory (Script liegt in src/ — Root ist eine Ebene höher)
...
Write-Host "         HELLION POWER TOOL v8.0.0.0 'Jörmungandr'                    " -ForegroundColor White
...
Write-Log "Hellion Power Tool v8.0.0.0 'Jörmungandr' started (Modular version)" -Color Cyan
...
do {
    ...
    switch ($choice.ToUpper()) {
        ...
        '14' {
            ...
            Write-Information "  [x] Zurück zum Hauptmenu" -InformationAction Continue
            ...
            switch ($memChoice.ToLower()) {
                ...
                'x' {
                    Write-Information "[INFO] Zurück zum Hauptmenu..." -InformationAction Continue
                }
                default {
        ...
        '16' {
            ...
            switch ($restoreChoice.ToLower()) {
                ...
                'x' {
                    Write-Information "Zurück zum Hauptmenu..." -InformationAction Continue
                }
                default {
...
Write-Log "[*] Log-Größe: $($logSummary.LogSize) KB" -Color Gray
