...
function Invoke-EnhancedAutoMode {
    ...
    Write-Host "`n[*] AUTO-MODUS OPTIONEN:" -ForegroundColor Cyan
    Write-Host "  [1] Basis-Optimierung (Sicher)" -ForegroundColor Green
    Write-Host "  [2] Erweiterte Optimierung (Empfohlen)" -ForegroundColor Yellow
    Write-Host "  [3] Vollstaendige Optimierung (Alles)" -ForegroundColor Red
